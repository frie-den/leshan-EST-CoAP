...
```
wget https://download.eclipse.org/leshan/2.x/lastSuccessfulBuild/artifact/leshan-demo-server.jar
java -jar ./leshan-demo-server.jar
```
Get and run the last binary of our demo **client** :
```
wget https://download.eclipse.org/leshan/2.x/lastSuccessfulBuild/artifact/leshan-demo-client.jar
java -jar ./leshan-demo-client.jar
```
Get and run the last binary of our **bootstrap** demo server :
```
wget https://download.eclipse.org/leshan/2.x/lastSuccessfulBuild/artifact/leshan-demo-bsserver.jar
